...
const server = new HttpServer(config.get('httpd.hostname'), config.get('httpd.port'), config.get('httpd.gid'), config.get('httpd.uid'));
server.addRoute(config.get('auth.username'), config.get('auth.password'));
